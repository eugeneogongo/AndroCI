package com.siddharthks.androci.ui.fragments;
...
import com.siddharthks.apicommunicator.models.BuildResponse;
...
import com.siddharthks.apicommunicator.models.submodels.ReposDefaultBranch;
import com.siddharthks.apicommunicator.models.submodels.ReposOwner;
import com.siddharthks.apicommunicator.models.RepoResponse;
import com.siddharthks.apicommunicator.models.submodels.Pagination;
import com.siddharthks.apicommunicator.restservices.OrgsService;
import com.siddharthks.apicommunicator.restservices.UserService;
import com.siddharthks.androci.ui.views.CircleTransform;
import com.squareup.picasso.Picasso;

import java.util.ArrayList;

import static android.content.Context.MODE_PRIVATE;
import static com.siddharthks.apicommunicator.restservices.ReposService.getRepos;
import static com.siddharthks.androci.common.views.BaseFragment.hideProgressBar;
import static com.siddharthks.androci.common.views.BaseFragment.showProgressBar;
import static com.siddharthks.androci.common.Constants.PREFS_NAME;
import static com.siddharthks.androci.utils.DateUtils.getDate;
import static com.siddharthks.androci.utils.DateUtils.rfc3339ToMills;
    ...
    public static class ContentAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public void onBindViewHolder(final ViewHolder holder, int position) {
            ...
            if(buildResponse == null) {
                ...
                if (buildResponse.getFinishedAt() == null) {
                    holder.last_run_time.setText("Running!");
                } else {
